...
import RelatoriosFotograficosDaOm from "./pages/RelatoriosFotograficosDaOm";
  ...
  return (
    <HashRouter>
      <Routes>
        ...
        <Route path="/ordens-manutencao/:id/relatorios-fotograficos" element={<RelatoriosFotograficosDaOm />} />
        <Route path="/ordens-manutencao/:id/relatorios-fotograficos/:relatorioId" element={<RelatorioFotografico />} />
